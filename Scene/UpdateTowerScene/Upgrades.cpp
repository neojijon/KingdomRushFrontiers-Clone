...
void Upgrades::initalState()
{
	if(!UserDefault::getInstance()->getBoolForKey("upgrades_icon_sta_isExit",false))
	{
		for(int i=0;i<5;i++)
			for(int j=0;j<6;j++)
			{
				UserDefault::getInstance()->setIntegerForKey(cocos2d::StringUtils::format("upgrades_icon_%d_%d",i,j).data(),(int)iconInitSta[i][j]);
			}
	...
	for(int j=0;j<6;j++)
		...
		{			
			...
			if(1==UserDefault::getInstance()->getIntegerForKey(cocos2d::StringUtils::format("upgrades_icon_%d_%d",i,j).data()))
			{
...
bool Upgrades::init()
{
	...
	bg2TileLtSprite->setPosition(Vec2(visibleSize.width*0.05,visibleSize.height*0.5));
	for(int i = 1;i<14;i++){
		auto by2TileMidSprite = Sprite::createWithSpriteFrameName("upgrades_bg2_tileMid.png");
		by2TileMidSprite->setPosition((Vec2(Vec2(visibleSize.width*0.05 + i*(by2TileMidSprite->getContentSize().width-5),visibleSize.height*0.5))));
		addChild(by2TileMidSprite,1);
	}
	
	bg2TileRtSprite->setPosition(Vec2(visibleSize.width*0.61,visibleSize.height*0.5));
	...
	icons[0][0]->setPosition(Vec2(visibleSize.width*0.08,visibleSize.height*0.25));
	...
	icons[1][0]->setPosition(Vec2(visibleSize.width*0.08,visibleSize.height*0.40));
	...
	icons[2][0]->setPosition(Vec2(visibleSize.width*0.08,visibleSize.height*0.55));
	...
	icons[3][0]->setPosition(Vec2(visibleSize.width*0.08,visibleSize.height*0.7));
	...
	icons[4][0]->setPosition(Vec2(visibleSize.width*0.08,visibleSize.height*0.85));
	...
	icons[0][1]->setPosition(Vec2(visibleSize.width*0.18,visibleSize.height*0.25));
	...
	icons[1][1]->setPosition(Vec2(visibleSize.width*0.18,visibleSize.height*0.40));
	...
	icons[2][1]->setPosition(Vec2(visibleSize.width*0.18,visibleSize.height*0.55));
	...
	icons[3][1]->setPosition(Vec2(visibleSize.width*0.18,visibleSize.height*0.7));
	...
	icons[4][1]->setPosition(Vec2(visibleSize.width*0.18,visibleSize.height*0.85));
	...
	icons[0][2]->setPosition(Vec2(visibleSize.width*0.28,visibleSize.height*0.25));
	...
	icons[1][2]->setPosition(Vec2(visibleSize.width*0.28,visibleSize.height*0.40));
	...
	icons[2][2]->setPosition(Vec2(visibleSize.width*0.28,visibleSize.height*0.55));
	...
	icons[3][2]->setPosition(Vec2(visibleSize.width*0.28,visibleSize.height*0.70));
	...
	icons[4][2]->setPosition(Vec2(visibleSize.width*0.28,visibleSize.height*0.85));
	...
	icons[0][3]->setPosition(Vec2(visibleSize.width*0.38,visibleSize.height*0.25));
	...
	icons[1][3]->setPosition(Vec2(visibleSize.width*0.38,visibleSize.height*0.40));
	...
	icons[2][3]->setPosition(Vec2(visibleSize.width*0.38,visibleSize.height*0.55));
	...
	icons[3][3]->setPosition(Vec2(visibleSize.width*0.38,visibleSize.height*0.7));
	...
	icons[4][3]->setPosition(Vec2(visibleSize.width*0.38,visibleSize.height*0.85));
	...
	icons[0][4]->setPosition(Vec2(visibleSize.width*0.48,visibleSize.height*0.25));
	...
	icons[1][4]->setPosition(Vec2(visibleSize.width*0.48,visibleSize.height*0.40));
	...
	icons[2][4]->setPosition(Vec2(visibleSize.width*0.48,visibleSize.height*0.55));
	...
	icons[3][4]->setPosition(Vec2(visibleSize.width*0.48,visibleSize.height*0.7));
	...
	icons[4][4]->setPosition(Vec2(visibleSize.width*0.48,visibleSize.height*0.85));
	...
	icons[0][5]->setPosition(Vec2(visibleSize.width*0.58,visibleSize.height*0.25));
	...
	icons[1][5]->setPosition(Vec2(visibleSize.width*0.58,visibleSize.height*0.40));
	...
	icons[2][5]->setPosition(Vec2(visibleSize.width*0.58,visibleSize.height*0.55));
	...
	icons[3][5]->setPosition(Vec2(visibleSize.width*0.58,visibleSize.height*0.7));
	...
	icons[4][5]->setPosition(Vec2(visibleSize.width*0.58,visibleSize.height*0.85));
	...
	rtSysShow->setPosition(Vec2(visibleSize.width*0.82,visibleSize.height*0.66));
	...
	buyButten->setPosition(Vec2(visibleSize.width*0.82,visibleSize.height*0.23));
	...
	reset->setPosition(Vec2(visibleSize.width*0.73,visibleSize.height*0.07));
	...
	sure->setPosition(Vec2(visibleSize.width*0.91,visibleSize.height*0.07));
	...
	//Ê£ÓàµÄÐÇÐÇÏÔÊ¾(±êÇ©)
	lastStartLabel = Label::createWithSystemFont(cocos2d::StringUtils::format("%d",startLeft),"Arial",50);
	//labelLastStart->setColor(ccc3(20,50,50));
    lastStartLabel->setPosition(Vec2(visibleSize.width*0.85, visibleSize.height*0.91));
	...
	upNeedStartLabel = Label::createWithSystemFont(cocos2d::StringUtils::format("%d",lastSelectedIcon->priceTag),"Arial",28);
	upNeedStartLabel->setColor(Color3B(0,0,0));
	upNeedStartLabel->setPosition(Vec2(visibleSize.width*0.92, visibleSize.height*0.75));
	addChild(upNeedStartLabel,2);

	//Í¼Æ¬Õ¹Ê¾
	iconDisplay=Sprite::create();
	iconDisplay->setSpriteFrame(lastSelectedIcon->icon->getSpriteFrame());
	iconDisplay->setPosition(Vec2(visibleSize.width*0.82, visibleSize.height*0.70));
	...
	iconNameLabel->setPosition(Vec2(visibleSize.width*0.82, visibleSize.height*0.60));
	...
	iconIntroductionLabel->setPosition(Vec2(visibleSize.width*0.82, visibleSize.height*0.38));
...
bool Upgrades::onIconTouchBegan(Touch* touch, Event* event)
{
	...
	{  	
		...
		upNeedStartLabel->setString(cocos2d::StringUtils::format("%d",lastSelectedIcon->priceTag));
...
void Upgrades::resetStaEnded(Touch* touch , Event* event)
{
	...
	{
		icons[i][j]->showIcon(Icons::eIconOff);
		UserDefault::getInstance()->setIntegerForKey(cocos2d::StringUtils::format("upgrades_icon_%d_%d",i,j).data(), 0);
	}
	initalState();
	UserDefault::getInstance()->setIntegerForKey(GameManager::getInstance()->SLOTX_STARLEFT,startLeft);
	lastStartLabel->setString(cocos2d::StringUtils::format("%d",startLeft));
...
void Upgrades::onBuyButTouchEnded(Touch* touch,Event* event)
{
	...
	UserDefault::getInstance()->setIntegerForKey(cocos2d::StringUtils::format("upgrades_icon_%d_%d",lastSelectedIcon->iconRow,lastSelectedIcon->iconColumn).data(),1);
