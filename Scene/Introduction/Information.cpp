...
Scene* Information::createScene()
{
   ...
   bool Information::init()
  {
   ...
   void Information::initMap()
   {
	   ...
	   item->setPosition(Vec2(size.width*0.2,size.height*0.25));
