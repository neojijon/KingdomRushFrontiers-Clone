...
void Road::initRoadAnimation()
{
	...
	{
		frame0 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_1to1_5_00%02d.png",len));
		if(frame0!=nullptr)
	...
	{
		frame1 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_1_5_to2_00%02d.png",len));
		if(frame1!=nullptr)
	...
	{
		frame2 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_2to3_00%02d.png",len));
		if(frame2!=nullptr)
	...
	{
		frame3 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_3to4_00%02d.png",len));
		if(frame3!=nullptr)
	...
	{
		frame4 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_4to5_0%03d.png",len));
		if(frame4!=nullptr)
	...
	{
		frame5 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_5to6_00%02d.png",len));
		if(frame5!=nullptr)
	...
	for (int len = 1;len <= 25; len++)
	{
		frame6 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_6to7_00%02d.png",len));
		if(frame6!=nullptr)
	...
	{
		frame7 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_7to8_00%02d.png",len));
		if(frame7!=nullptr)
	...
	for (int len = 1;len <= 22; len++)
	{
		frame8 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_8to9_00%02d.png",len));
		if(frame8!=nullptr)
	...
	{
		frame9 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_9to10_00%02d.png",len));
		if(frame9!=nullptr)
	...
	for (int len = 1;len <= 13; len++)
	{
		frame10 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_10to11_00%02d.png",len));
		if(frame10!=nullptr)
	...
	for (int len = 1;len <= 10; len++)
	{
		frame11 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_11to12_00%02d.png",len));
		if(frame11!=nullptr)
	...
	for (int len = 1;len <= 7; len++)
	{
		frame12 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_12to13_00%02d.png",len));
		if(frame12!=nullptr)
	...
	for (int len = 1;len <= 7; len++)
	{
		frame13 = SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("mapRoad_12to13_00%02d.png",len));
		if(frame13!=nullptr)
