...
void Level0::addTerrains()
{
	...
	terrain1->setPosition(Vec2(600,780));//左边下
	terrain1->setTag(1);
	addChild(terrain1,3);
	...
	terrain4->setPosition(Vec2(520,610));//左边上
	terrain4->setTag(4);
	addChild(terrain4,4);

	auto terrain5 = CustomTerrain::createTerrain(1);
	terrain5->setPosition(Vec2(675,610));//右边上
	terrain5->setTag(5);
	addChild(terrain5,4);

	auto terrain6 = CustomTerrain::createTerrain(1);
	terrain6->setPosition(Vec2(475,530));//左边
	terrain6->setTag(6);
	addChild(terrain6,5);

	auto terrain7 = CustomTerrain::createTerrain(1);
	terrain7->setPosition(Vec2(720,530));//右边
	terrain7->setTag(7);
	addChild(terrain7,5);

	auto terrain2 = CustomTerrain::createTerrain(1);
	terrain2->setPosition(Vec2(520,445));//最上面的
	terrain2->setTag(2);
	addChild(terrain2,6);

	auto terrain3 = CustomTerrain::createTerrain(1);
	terrain3->setPosition(Vec2(675,445));//右边下
	terrain3->setTag(3);
	addChild(terrain3,6);
	...
	terrain8->setPosition(Vec2(600,270));//最下面的
	terrain8->setTag(8);
	addChild(terrain8,8);
