...
{
	towerBase = Sprite::createWithSpriteFrameName(cocos2d::StringUtils::format("tower_barracks_lvl%d_layer1_0001.png",level));
	door = Sprite::createWithSpriteFrameName(cocos2d::StringUtils::format("tower_barracks_lvl%d_layer2_0001.png",level));

	addChild(towerBase);
	addChild(door);
	
	auto Soldier_1 = BarrackSoldier::createSoldier(Vec2(40,-30),level);
	auto Soldier_2 = BarrackSoldier::createSoldier(Vec2(-40,-30),level);
	auto Soldier_3 = BarrackSoldier::createSoldier(Vec2(0,-40),level);
	...
	door->runAction(Animate::create(AnimationCache::getInstance()->getAnimation(cocos2d::StringUtils::format("level%d_barracks_opendoor",getLevel()))));
...
void BaseBarracksTower::updateTower()
{
	...
	towerBase -> setSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("tower_barracks_lvl%d_layer1_0001.png",level)));
	door->setSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(cocos2d::StringUtils::format("tower_barracks_lvl%d_layer2_0001.png",level)));
	for(int i = 0; i< Soldiers.size() ;i++)
	{
...
void BaseBarracksTower::setRallyVec2(Vec2 point)
{
	...
	Soldiers.at(0)->setLocation(Vec2(rally.x + 20,rally.y - 20));
	Soldiers.at(1)->setLocation(Vec2(rally.x - 20,rally.y - 20));
	Soldiers.at(2)->setLocation(Vec2(rally.x ,rally.y + 20));
